...
// Function to generate animated Barnsley Fern points (unchanged for brevity)
...
export default function Canvas() {
    // State and ref declarations (unchanged for brevity)
    ...
    const [isPanelOpen, setIsPanelOpen] = useState(true); // New state for collapsible panel

    // useEffect hooks for state synchronization and rendering (unchanged for brevity)
    ...
    useEffect(() => {
        ...
        // Mouse and wheel event handlers (unchanged)
